...
```text
โจทย์จะอินพุตข้อมูลเป็นstr โดยที่outputจะกลับรูปแบบโดย เอาตัวหลังสุดไว้หน้าสุด เงื่อนไขคือตัวเล็กทั้งหมด
```
...
```text
Step 1:เขียนinputจากโจทย์ที่กำหนด โดยเพิ่มlowerเข้าไปด้วย
Step 2:ดูเงื่อนไขของโจทย์ว่าต้องให้กลับตัวอักษรจากหลังมาหน้า
Step 3:เขียนเงื่อนไข[start:stop:step]พร้อมคำสั่งoutput
```
...
```text
จากโจทย์ที่กำหนดว่า 5 ตัวอักษร ทำให้อยากทราบว่าถ้าใส่มากก่านั้นจะเป็นอย่างไร
```
...
```text
ลองตัวใหญ่ทุกตัวเพื่อเช็๕ว่าตัว.lower()ถูกต้องมั้ย
```
...
```text
อยากทราบว่าถ้ามีอักขระพิเศษสามารถรันได้หรือไม่
```
