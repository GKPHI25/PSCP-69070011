...
```text
รับค่าตัวเลข แล้วดูว่าหารสิบลงตัวมั้ย ถ้าลงให้แสดงผลแบบถอยหลังไปเรื่อยๆ
```
...
```text
Step 1:เขียนinputรับค่าเป็นint
Step 2:ดูเงื่อนไขต้องหารสิบลงตัวแล้วแสดงผลออกมาแบบถอยหลังลง
Step 3:เขียนลูปfor i in range(start,stop,step)
step 4:outputออกมาให้เป็นแถวเดียวกันโดยวิธี end=" "
```
...
```text
สงสัยว่าถ้ารันเลข0000จะเกิดอะไรขึ้น
```
...
```text
อยากรู้ว่าถ้าเลขเดี่ยวจะแสดงผลออกเป็นแบบไหน
```
