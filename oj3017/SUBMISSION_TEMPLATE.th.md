...
```text
รับค่าเงินที่ต้องจ่าย แล้วนำอินพุตไปคำนวนค่าบริการสิบเปอร์เซน เสร็จแล้วก็เข้าเงื่อนไขว่าถ้าค่าบริการน้อยกว่าห้าสิบให้เท่ากับห้าสิบ แต่ถ้าเกินหนึ่งพัน ให้ค่าบริการมากสุดแค่หนึ่งพัน ต่อจากนี้เราจะนำมาคำนวนพร้อมกับคิดภาษีเพิ่มอีกเจ็ดเปอร์เซน
output
```
...
```text
Step 1:เขียนinputรับค่าใช่จ่ายอาหาร รับค่าเป็นint
Step 2:นำอินพุตมาคำนวนกับค่าบริการสิบเปอร์เซน
Step 3:เข้าเงื่อนไขเช็คว่าค่าบริการน้อยกว่าห้าสิบให้ทำเป็นห้าสิบ แต่ถ้ามากกว่าหนึ่งพันให้ค่าบริการมากสุดที่หนึ่งพัน
Step 4:นำมาคำนวนต่อเพิ่มภาษีอีกเจ็ดเปอร์เซ็น พร้อมกับoutput
```
...
```text
เหมือนกัน เพราะว่า แผนเดิมครอบคลุมและถูกต้องแล้ว
```
...
```text
ใส่อินพุตเยอะๆจะแสดงผลแบบไหน เพื่อเช็คค่าบริการสูงสุด
```
...
```text
ใส่เลข0จะเป็นยังไง เพื่อเช็คค่าบริการน้อยสุด
```
